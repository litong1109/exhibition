package com.zel.web.controller.demo.controller;
...
import com.zel.common.json.JSONObject;
import com.zel.common.json.JSONObject.JSONArray;
...
public class DemoFormController
{
    ...
    {
        String[] array = { "zel 1", "zel 2", "zel 3", "zel 4", "zel 5" };
        AjaxResult ajax = new AjaxResult();
